...
# LoadIntConst { value: 5000, dest: IRVar { name: Identifier("x9"), var_type: Integer } }
movq $5000, -88(%rbp)

# Call { fun: IRVar { name: Operator(GT), var_type: Function(FunctionType { param_types: [Integer, Integer], return_type: Boolean }) }, args: [IRVar { name: Identifier("x0"), var_type: Integer }, IRVar { name: Identifier("x9"), var_type: Integer }], dest: IRVar { name: Identifier("x10"), var_type: Boolean } }
xor %rax, %rax
movq -8(%rbp), %rdx
cmpq -88(%rbp), %rdx
setg %al
